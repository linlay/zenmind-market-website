...
export const marketCopy = {
  'zh-CN': {
    ...
    usageHintHint: '每条最多 80 字；技能卡片进入视口后会按顺序循环播放，留空的提示不展示。',
    usageHintTitle: '如何使用',
    readme: 'README',
    author: '作者',
    metadataUrl: '外部 URL',
  ...
  'en-US': {
    ...
    usageHintHint: 'Up to 80 characters each. Hints cycle in order once the skill card enters view; blank hints are hidden.',
