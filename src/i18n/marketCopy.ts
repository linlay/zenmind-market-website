...
export const marketCopy = {
  ...
  'en-US': {
    ...
    publishTypeDescriptions: {
      ...
      mcp: 'Search and publish an existing MCP service from the gateway.',
    ...
    publishTypeRequirementsMap: {
      ...
      mcp: 'Select an MCP from the gateway; no artifact upload',
