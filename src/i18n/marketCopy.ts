...
export const marketCopy = {
  'zh-CN': {
    ...
    connectorPartUploadHint: 'MCP、CLI 和 Skill 可同时选择；提交后市场会自动生成 connector.json 和已启用能力的声明。',
    connectorPartUploadRequirement: '至少选择 MCP 或 CLI；Skill 是可选组件，可与 MCP、CLI 任意组合。',
    connectorKind: '连接器子类',
  ...
  'en-US': {
    ...
    connectorPartUploadHint: 'MCP, CLI, and Skill can be enabled together. Market generates connector.json and all enabled capability manifests on submit.',
    connectorPartUploadRequirement: 'Enable at least MCP or CLI. Skill is optional and can accompany either or both.',
