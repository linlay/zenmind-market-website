...
export const marketCopy = {
  'zh-CN': {
    ...
    loginAsCreator: '普通用户',
    loginAsAdmin: '管理员',
    loginAsSecurityReviewer: '安全审核人',
    loginRequired: '请先登录。',
    downloadLoginRequired: '请登录后进行下载。',
    adminReviewEntry: '审核管理',
    securityReviewEntry: '安全审核',
    ...
    creatorEditMetadata: '编辑附加信息',
    editMetadataTitle: '编辑已发布版本信息',
    editMetadataBody: (version) => `直接更新版本 ${version} 的展示信息与开放人群，版本号保持不变。`,
    editMetadataLocked: '此项不可修改',
    editMetadataJSON: '附加元数据 JSON',
    editMetadataJSONHint: '仅用于展示类附加信息；连接器、网站端点、工具配置和统计字段会由服务端保持不变。',
    editMetadataImageHint: '选择新图片可替换组件展示图，不上传则保留当前图片。',
    editMetadataArtifactTitle: '制品受保护',
    editMetadataArtifactBody: '此入口不会接收或修改制品、平台、依赖及安装协议。如需更新任何制品文件，请发布新版本。',
    editMetadataSubmit: '保存附加信息',
    editMetadataSaving: '正在保存...',
    editMetadataSuccess: '附加信息已更新，版本号和制品均未变化。',
    editMetadataFailed: (reason) => `附加信息更新失败：${reason}`,
    creatorPendingVersion: (version) => `版本 ${version} 正在发布`,
    creatorRejectedVersion: (version) => `版本 ${version} 已驳回`,
    publishVersionTitle: '发布新版本',
    publishVersionBody: '组件类型和 ID 已锁定；请确认完整配置并上传新制品。验证通过后会立即发布。',
    publishVersionSubmit: '发布新版本',
    ...
    reviewCenter: '审核中心',
    reviewStatus: '审核状态',
    creatorComponentStatus: '审核 / 上架状态',
    reviewPending: '待审核',
    reviewApproved: '已通过',
    reviewRejected: '已驳回',
    publicationPublished: '已上架',
    publicationUnpublished: '已下架',
    publicationNotPublished: '未上架',
    reviewApprove: '通过',
    reviewReject: '驳回',
    ...
    securityReview: '安全审核中心',
    securityReviewSubtitle: '仅处理当前等待安全审核的组件。安全通过后，组件将进入管理员审核。',
    securityPending: '待安全审核组件',
    securityNoPending: '当前没有待安全审核组件。',
    securityOnlyPendingHint: '这里只展示当前处于安全审核节点的组件。',
    reviewOpen: '审核详情',
    ...
    deleteComponent: '永久删除',
    deleteComponentConfirm: (name) => `确认永久删除「${name}」吗？所有版本、制品、审核记录、下载记录、收藏和评论都会被清除，且无法恢复。`,
    deleteComponentSuccess: '组件及其全部关联数据已永久删除。',
    deleteComponentFailed: (reason) => `删除失败：${reason}`,
    ...
    skillIncludedCount: (count) => `包含技能 (${count}个)`,
    skillIncludedMore: (count) => `还有 ${count} 个技能`,
    ...
    adminRemoveFeatured: '取消精选',
    adminSetFeaturedSuccess: '已设为官方精选。',
    adminRemoveFeaturedSuccess: '已取消官方精选。',
    adminFeaturedFailed: (reason) => `更新精选状态失败：${reason}`,
    skillCategories: {
      all: '全部技能',
      document: '文档处理',
      data: '数据分析',
    ...
    emptyCatalogBody: '暂无可用组件，请通过开发者发布功能上传并发布组件。',
    loadingTitle: '正在加载市场',
    ...
    skillMdTitle: '技能说明',
    skillMdLoading: '正在读取 SKILL.md…',
    skillMdEmpty: 'SKILL.md 暂无内容。',
    skillMdFailed: (reason) => `SKILL.md 读取失败：${reason}`,
    expand: '展开',
    collapse: '收起',
    ratingEyebrow: '使用反馈',
    ratingTitle: '组件评分',
    ratingCount: (count) => `${count || 0} 条评分`,
    ratingNone: '暂无评分',
    ratingPrompt: '立即开始评分吧',
    ratingYours: '你的评分',
    ratingLoginRequired: '登录并下载组件后才可以评分。',
    ratingDownloadRequired: '下载过该组件后才可以评分。',
    ratingFailed: (reason) => `评分失败：${reason}`,
    rateStar: (star) => `评 ${star} 星`,
    starUnit: '星',
    noDescription: '暂无描述。',
    noDependencies: '暂无依赖。',
    downloadArtifact: '下载',
	...
	accessScope: '访问权限',
	accessAll: '全员可见',
	accessDepartment: '部门内可见',
	accessUsers: '指定用户可见',
	accessRestricted: '限定人群可见',
	accessExtraUsers: '额外指定用户',
	accessRestrictedRequired: '请至少选择一个可见部门或指定用户。',
	accessAllHint: '所有人均可访问，包括未登录游客。',
	accessNoDepartment: '尚未同步到部门信息，请重新登录或联系管理员。',
	accessUserSearch: '输入姓名、工号或 OA 账号',
	accessSearch: '搜索',
	accessDirectoryError: '用户目录暂时不可用，请稍后重试。',
    publishRequiredAssets: '必需材料',
	addPlatformVariant: '添加平台制品',
	removePlatformVariant: '移除平台',
	duplicatePlatformVariant: '同一个系统和架构只能添加一次。',
    ...
    publishTypeDescriptions: {
      connector: '填写 MCP、CLI、认证与 Skill 配置，由市场组装并校验标准连接器包。',
      skill: '上传单个技能，支持一键安装。',
    ...
    publishTypeRequirementsMap: {
      connector: 'MCP 或 CLI 配置；可选 Skill / CLI ZIP',
    ...
    connectorPartUploadHint: '选择连接器包含的能力并填写必要配置。提交时市场会生成标准目录、执行完整校验，然后固定为不可变制品。',
    connectorPartUploadRequirement: '至少选择 MCP 或 CLI；主调用类型必须属于已选择的能力。Skill 与随包 CLI 制品可选。',
    connectorPackageHint: '仅支持 .zip；包内路径和声明将按连接器规范校验',
    connectorPrimaryTypeField: '主要调用方式',
    connectorAuthModeField: '认证方式',
    connectorAuthNull: '无平台托管认证 / CLI 自行登录',
    connectorAuthBrowserField: '认证浏览器',
    connectorAuthBrowserSystem: '系统浏览器',
    connectorAuthBrowserEmbedded: '内置浏览器',
    connectorAuthBrowserHint: '需要打开认证页面时使用的浏览器类型。',
    connectorTokenTitle: 'Token 凭据表单',
    connectorTokenFormTitle: '表单标题',
    connectorTokenKey: '凭据变量名',
    connectorTokenLabel: '用户看到的字段名',
    connectorTokenInputType: '输入类型',
    connectorTokenDocURL: '凭据获取文档',
    connectorMCPAuthHeader: '注入的 MCP Header 名',
    connectorMCPAuthEnv: '注入的 MCP 环境变量名',
    connectorMCPAuthPrefix: 'Header 值前缀',
    connectorCLIAuthEnv: '注入的 CLI 环境变量名',
    connectorOAuthTitle: 'OAuth 公开配置',
    connectorOAuthScopes: 'Scopes（空格或逗号分隔）',
    mcpServerName: 'Server 名称',
    connectorArgsHint: '每行一个参数；不会按空格再次拆分',
    mcpTimeout: '调用超时（毫秒）',
    mcpStaticHeaderName: '固定 Header 名',
    mcpStaticHeaderValue: '固定 Header 值',
    staticEnvName: '固定环境变量名',
    staticEnvValue: '固定环境变量值',
    cliRuntimeToggle: '声明运行时依赖',
    cliAuthToggle: '由平台编排 CLI 登录',
    cliTargetSystem: '命令配置系统',
    cliTargetSystemHint: '选择系统并填写对应命令；切换系统时已填写内容会保留。只有添加到下方发布目标的系统才会生成制品。',
    connectorPlatformTargets: '平台制品目标',
    connectorPlatformTargetsHint: '每个系统和架构会生成独立连接器包，下载时市场自动匹配当前平台。',
    cliPlatformArchiveHint: '可选：仅上传当前平台的 CLI 可执行文件和依赖；通过 npm 等命令安装时留空。',
    connectorSkillsArchive: 'Skills ZIP 包',
    connectorSkillsArchiveHint: '上传完整 Skills 目录。ZIP 根目录可以是各 Skill 文件夹，也可以直接包含 skills/；每个 Skill 的 references/ 等辅助文件都会原样保留。',
    cliArchiveHint: '可选：上传仅包含 CLI 可执行文件和依赖的 ZIP，市场会放入 connector/bin/。',
    connectorKind: '连接器子类',
    mcpTransport: 'MCP 传输方式',
    mcpCommand: 'stdio 执行地址',
    mcpURL: 'HTTP 服务地址',
    connectorArgs: '运行参数',
    mcpHTTPParams: 'HTTP 请求参数（Header=值）',
    cliUploadMode: 'CLI 制品方式',
    cliNoArchive: '仅填写命令',
    cliWithArchive: '上传 ZIP 可执行包',
    cliArchive: 'CLI ZIP 包',
    cliCommand: '执行命令',
    skillVersion: 'Skill 版本号',
    ...
    publishSuccess: (name) => `组件 [${name}] 已发布！`,
    publishFailed: (reason) => `发布失败：${reason}`,
    publishing: '正在发布...',
    artifact: '制品包',
    artifactSourceUpload: '上传本地制品包',
    artifactSourceRepository: '从 GitHub / GitLab 仓库导入',
    repositoryProvider: '仓库平台',
    repositoryUrl: '仓库地址',
    repositoryUrlRequired: '请输入仓库地址。',
    repositoryRef: '分支、Tag 或 Commit（默认 HEAD）',
    repositoryPath: 'Skill 所在子目录（可选）',
    repositoryAccessToken: 'Access Token（私有仓库必填）',
    repositoryAccessTokenPlaceholder: '仅用于本次导入',
    repositoryAccessTokenHint: 'Token 只发送到市场服务端并用于本次拉取，不会保存到数据库、制品或日志。建议使用只读仓库权限和短有效期 Token。',
    image: '展示图片',
    ...
    tags: '标签',
    usageHint: '卡片使用提示（最多 3 条）',
    usageHintPlaceholder: '例如：输入文档链接和操作指令，即可创建、读取或更新在线文档。',
    usageHintHint: '每条最多 80 字；技能和连接器卡片进入视口后会按顺序循环播放，留空的提示不展示。',
    usageHintTitle: '如何使用',
    connectorUsageTitle: '适合这样用',
    copyUsageHint: '复制提示词',
    usageHintCopied: '已复制',
    readme: 'README',
    author: '作者',
    metadataUrl: '外部 URL',
    connectorProfile: '连接器声明',
    connectorPrimaryType: '主要调用方式',
    connectorAuthMode: '认证模式',
    connectorSpecVersion: '规范版本',
    connectorComponentsTitle: '连接器组件',
    connectorComponentsDescription: '安装后将获得以下技能与工具能力。',
    connectorSkillsTitle: '技能',
    connectorSkillDescription: (name) => `${name} 提供连接器内置的任务指引与操作流程。`,
    connectorSkillFallbackName: '内置技能',
    connectorSkillFallbackDescription: '提供与此服务配套的任务指引与操作流程。',
    connectorMCPFallbackName: 'MCP 服务',
    connectorMCPDescription: (transports) => `通过 ${transports} 协议连接服务，让智能体调用远程工具和数据。`,
    connectorMCPFallbackDescription: '连接外部服务，让智能体调用其工具和数据。',
    connectorCLIName: '命令行工具',
    connectorCLIDescription: (platforms) => `为 ${platforms} 提供本地命令调用、版本检测与授权能力。`,
    connectorCLIFallbackDescription: '提供本地命令调用、版本检测与授权能力。',
    connectorToolCount: (count) => `${count} 种传输方式`,
    connectorPlatformCount: (count) => `${count} 个平台`,
    connectorComponentCount: (count) => `${count} 个`,
    connectorExpandComponents: (count) => `展开另外 ${count} 个`,
    connectorCollapseComponents: '收起',
    sandboxKind: '沙箱类型',
    websiteKind: '网站类型',
    categories: {
      all: '全部功能',
  ...
  'en-US': {
    ...
    loginAsCreator: 'User',
    loginAsAdmin: 'Admin',
    loginAsSecurityReviewer: 'Security reviewer',
    loginRequired: 'Sign in first.',
    downloadLoginRequired: 'Sign in to download.',
    adminReviewEntry: 'Review Admin',
    securityReviewEntry: 'Security Review',
    ...
    creatorEditMetadata: 'Edit metadata',
    editMetadataTitle: 'Edit published release information',
    editMetadataBody: (version) => `Update the display information and audience for version ${version} without changing its version number.`,
    editMetadataLocked: 'This field cannot be changed',
    editMetadataJSON: 'Additional metadata JSON',
    editMetadataJSONHint: 'For descriptive metadata only. Connector, website endpoints, tool configuration, and counters are preserved by the server.',
    editMetadataImageHint: 'Pick a new file to replace the display image; leave it empty to keep the current one.',
    editMetadataArtifactTitle: 'Artifact protected',
    editMetadataArtifactBody: 'This form cannot accept or modify artifacts, platforms, dependencies, or install protocols. Publish a new version to change any artifact file.',
    editMetadataSubmit: 'Save information',
    editMetadataSaving: 'Saving...',
    editMetadataSuccess: 'Information updated. The version and artifact are unchanged.',
    editMetadataFailed: (reason) => `Could not update information: ${reason}`,
    creatorPendingVersion: (version) => `Version ${version} is publishing`,
    creatorRejectedVersion: (version) => `Version ${version} was rejected`,
    publishVersionTitle: 'Publish New Version',
    publishVersionBody: 'Component type and ID are locked. Confirm the configuration and upload the new artifact. It is published immediately after validation.',
    publishVersionSubmit: 'Publish new version',
    ...
    creatorProfileName: 'Market Creator',
    ...
    creatorComponentStatus: 'Review / listing status',
    reviewPending: 'Pending',
    reviewApproved: 'Approved',
    reviewRejected: 'Rejected',
    publicationPublished: 'Listed',
    publicationUnpublished: 'Unlisted',
    publicationNotPublished: 'Not listed',
    ...
    securityReview: 'Security Review Center',
    securityReviewSubtitle: 'Review only components currently waiting for security approval. Approved components move to admin review.',
    securityPending: 'Pending security reviews',
    securityNoPending: 'There are no pending security reviews.',
    securityOnlyPendingHint: 'Only components at the security review stage appear here.',
    ...
    deleteComponent: 'Delete permanently',
    deleteComponentConfirm: (name) => `Permanently delete “${name}”? All versions, artifacts, reviews, downloads, favorites, and comments will be removed and cannot be recovered.`,
    deleteComponentSuccess: 'The component and all related data were permanently deleted.',
    deleteComponentFailed: (reason) => `Delete failed: ${reason}`,
    ...
    skillIncludedCount: (count) => `Included skills (${count})`,
    skillIncludedMore: (count) => `${count} more skills`,
    ...
    skillLevel: 'Level',
    officialFeatured: 'Official selection',
    adminSetFeatured: 'Feature',
    adminRemoveFeatured: 'Remove feature',
    adminSetFeaturedSuccess: 'Added to Official selection.',
    adminRemoveFeaturedSuccess: 'Removed from Official selection.',
    adminFeaturedFailed: (reason) => `Could not update featured status: ${reason}`,
    skillCategories: {
      all: 'All skills',
      document: 'Documents',
      data: 'Data analysis',
    ...
    emptyCatalogBody: 'No components are currently available. Publish a component through the developer portal.',
    ...
    skillMdTitle: 'Skill instructions',
    skillMdLoading: 'Loading SKILL.md…',
    skillMdEmpty: 'SKILL.md is empty.',
    skillMdFailed: (reason) => `Could not load SKILL.md: ${reason}`,
    expand: 'Expand',
    collapse: 'Collapse',
    ratingEyebrow: 'User feedback',
    ratingTitle: 'Component rating',
    ratingCount: (count) => `${count || 0} ratings`,
    ratingNone: 'No ratings',
    ratingPrompt: 'Rate this component',
    ratingYours: 'Your rating',
    ratingLoginRequired: 'Sign in and download this component before rating.',
    ratingDownloadRequired: 'Download this component before rating it.',
    ratingFailed: (reason) => `Rating failed: ${reason}`,
    rateStar: (star) => `Rate ${star} stars`,
    starUnit: 'stars',
	...
	accessAll: 'Visible to everyone',
	accessDepartment: 'Department only',
	accessUsers: 'Specific users',
	accessRestricted: 'Restricted audience',
	accessExtraUsers: 'Additional users',
	accessRestrictedRequired: 'Select at least one department or specific user.',
	accessAllHint: 'Available to everyone, including signed-out visitors.',
	accessNoDepartment: 'No department information is available. Sign in again or contact an administrator.',
	accessUserSearch: 'Search by name, employee number, or OA account',
	accessSearch: 'Search',
	accessDirectoryError: 'The user directory is temporarily unavailable.',
    publishRequiredAssets: 'Required assets',
	addPlatformVariant: 'Add platform artifact',
	removePlatformVariant: 'Remove platform',
	duplicatePlatformVariant: 'Each operating system and architecture can only be added once.',
    ...
    publishTypeDescriptions: {
      connector: 'Describe MCP, CLI, authentication, and Skills; Market assembles and validates the standard connector package.',
    ...
    publishTypeRequirementsMap: {
      connector: 'MCP or CLI configuration; optional Skill / CLI ZIP',
    ...
    connectorPartUploadHint: 'Choose the included capabilities and provide the required configuration. Market generates the standard layout, validates it, then fixes it as an immutable artifact.',
    connectorPartUploadRequirement: 'Enable MCP or CLI. The primary invocation type must be enabled. Skill and packaged CLI artifacts are optional.',
    connectorPackageHint: '.zip only; package paths and manifests are validated against the connector specification',
    connectorPrimaryTypeField: 'Primary invocation type',
    connectorAuthModeField: 'Authentication mode',
    connectorAuthNull: 'No hosted credentials / CLI-managed login',
    connectorAuthBrowserField: 'Authentication browser',
    connectorAuthBrowserSystem: 'System browser',
    connectorAuthBrowserEmbedded: 'Embedded browser',
    connectorAuthBrowserHint: 'Browser used when an authentication page must be opened.',
    connectorTokenTitle: 'Token credential form',
    connectorTokenFormTitle: 'Form title',
    connectorTokenKey: 'Credential variable',
    connectorTokenLabel: 'User-facing field label',
    connectorTokenInputType: 'Input type',
    connectorTokenDocURL: 'Credential documentation',
    connectorMCPAuthHeader: 'Injected MCP header',
    connectorMCPAuthEnv: 'Injected MCP environment variable',
    connectorMCPAuthPrefix: 'Header value prefix',
    connectorCLIAuthEnv: 'Injected CLI environment variable',
    connectorOAuthTitle: 'Public OAuth configuration',
    connectorOAuthScopes: 'Scopes (space or comma separated)',
    mcpServerName: 'Server name',
    connectorArgsHint: 'One argument per line; spaces inside an argument are preserved.',
    mcpTimeout: 'Request timeout (ms)',
    mcpStaticHeaderName: 'Static header name',
    mcpStaticHeaderValue: 'Static header value',
    staticEnvName: 'Static environment variable',
    staticEnvValue: 'Static environment value',
    cliRuntimeToggle: 'Declare a runtime dependency',
    cliAuthToggle: 'Let the platform orchestrate CLI login',
    cliTargetSystem: 'Command operating system',
    cliTargetSystemHint: 'Select an operating system and enter its commands. Values are preserved when switching. Only systems added as release targets below produce artifacts.',
    connectorPlatformTargets: 'Platform artifact targets',
    connectorPlatformTargetsHint: 'A separate connector package is generated for every OS and architecture; downloads automatically resolve to the current platform.',
    cliPlatformArchiveHint: 'Optional executable and dependency ZIP for this platform only. Leave empty when the CLI is installed through npm or another command.',
    connectorSkillsArchive: 'Skills ZIP archive',
    connectorSkillsArchiveHint: 'Upload the complete Skills directory. The ZIP may contain Skill folders at its root or an outer skills/ directory; references and other supporting files are preserved.',
    cliArchiveHint: 'Optional ZIP containing only CLI executables and libraries. Market places its contents under connector/bin/.',
    connectorKind: 'Connector subtype',
    mcpTransport: 'MCP transport',
    mcpCommand: 'stdio executable',
    mcpURL: 'HTTP service URL',
    connectorArgs: 'Arguments',
    mcpHTTPParams: 'HTTP parameters (Header=value)',
    cliUploadMode: 'CLI artifact mode',
    cliNoArchive: 'Command only',
    cliWithArchive: 'Upload executable ZIP',
    cliArchive: 'CLI ZIP archive',
    ...
    artifactSourceUpload: 'Upload a local artifact',
    artifactSourceRepository: 'Import from GitHub / GitLab',
    repositoryProvider: 'Repository provider',
    repositoryUrl: 'Repository URL',
    repositoryUrlRequired: 'Enter a repository URL.',
    repositoryRef: 'Branch, tag, or commit (HEAD by default)',
    repositoryPath: 'Skill subdirectory (optional)',
    repositoryAccessToken: 'Access token (required for private repositories)',
    repositoryAccessTokenPlaceholder: 'Used for this import only',
    repositoryAccessTokenHint: 'The token is sent only to the Market server for this import and is not stored in the database, artifact, or logs. Use a short-lived read-only token.',
    image: 'Display image',
    ...
    tags: 'Tags',
    usageHint: 'Card usage hints (up to 3)',
    usageHintPlaceholder: 'For example: Enter a document link and instruction to create, read, or update it.',
    usageHintHint: 'Up to 80 characters each. Hints cycle in order once a skill or connector card enters view; blank hints are hidden.',
    usageHintTitle: 'How to use',
    connectorUsageTitle: 'Great for',
    copyUsageHint: 'Copy prompt',
    usageHintCopied: 'Copied',
    readme: 'README',
    author: 'Author',
    metadataUrl: 'External URL',
    connectorProfile: 'Connector manifest',
    connectorPrimaryType: 'Primary interface',
    connectorAuthMode: 'Authentication',
    connectorSpecVersion: 'Specification',
    connectorComponentsTitle: 'Connector components',
    connectorComponentsDescription: 'Installing this connector adds the following skills and tool interfaces.',
    connectorSkillsTitle: 'Skills',
    connectorSkillDescription: (name) => `${name} provides built-in task guidance and workflows for this connector.`,
    connectorSkillFallbackName: 'Built-in skill',
    connectorSkillFallbackDescription: 'Provides task guidance and workflows tailored to this service.',
    connectorMCPFallbackName: 'MCP service',
    connectorMCPDescription: (transports) => `Connects through ${transports}, allowing agents to use remote tools and data.`,
    connectorMCPFallbackDescription: 'Connects an external service so agents can use its tools and data.',
    connectorCLIName: 'Command-line tool',
    connectorCLIDescription: (platforms) => `Provides local commands, version checks, and authentication for ${platforms}.`,
    connectorCLIFallbackDescription: 'Provides local commands, version checks, and authentication.',
    connectorToolCount: (count) => `${count} transport${count === 1 ? '' : 's'}`,
    connectorPlatformCount: (count) => `${count} platform${count === 1 ? '' : 's'}`,
    connectorComponentCount: (count) => `${count} item${count === 1 ? '' : 's'}`,
