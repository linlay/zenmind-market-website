...
export const marketCopy = {
  'zh-CN': {
    ...
    connectorPartUploadHint: '选择 MCP、CLI 或 Skill 之一并填写运行配置；提交后市场会自动生成 connector.json 和对应能力声明。',
    connectorPartUploadRequirement: '无需手工编写 connector.json。CLI 可选上传含可执行文件的 ZIP；Skill 必须上传 SKILL.md。',
    connectorKind: '连接器子类',
  ...
  'en-US': {
    ...
    connectorPartUploadHint: 'Choose MCP, CLI, or Skill and enter its runtime configuration. Market generates connector.json and the capability manifest on submit.',
    connectorPartUploadRequirement: 'You do not need to author connector.json. CLI may include a ZIP containing executables; Skill requires SKILL.md.',
