...
export const marketCopy = {
  'zh-CN': {
    ...
    editMetadataJSONHint: '仅用于展示类附加信息；MCP/网站端点、工具配置和统计字段会由服务端保持不变。',
    ...
    publishTypeDescriptions: {
      ...
      agent: '上传智能体定义和运行资源。',
      mcp: '从 MCP 网关选择，或填入自定义 MCP 服务地址发布。',
    ...
    author: '作者',
    metadataUrl: '外部 URL',
    mcpGatewaySource: '选择网关 MCP',
    mcpGatewaySearch: '按名称、编码或介绍搜索 MCP',
    mcpGatewaySearchAction: '搜索',
    mcpGatewayLoading: '正在读取 MCP 网关目录...',
    mcpGatewayEmpty: '没有找到可用的 MCP。',
    mcpGatewayRequired: '请先从 MCP 网关选择一个服务。',
    mcpSourceLabel: 'MCP 来源',
    mcpSourceGateway: '从网关选择',
    mcpSourceCustom: '自定义地址',
    mcpCustomEndpoint: 'MCP 服务地址',
    mcpCustomEndpointRequired: '请输入 MCP 服务地址。',
    mcpCustomEndpointInvalid: 'MCP 服务地址必须是有效的 http(s) 地址。',
    mcpCustomServerKey: '服务标识（可选）',
    mcpCustomServerKeyHint: '用于生成 .mcp.json 中 mcpServers 的键名，留空时使用组件 ID。',
    mcpCustomTools: '可用工具（可选）',
    mcpCustomToolsHint: '多个工具用英文逗号分隔，例如 search,fetch。',
    mcpSourceBadgeGateway: '网关来源',
    mcpSourceBadgeCustom: '自定义地址',
    mcpEndpoint: '调用地址',
    mcpTools: '可用工具',
    sandboxKind: '沙箱类型',
    websiteKind: '网站类型',
  ...
  'en-US': {
    ...
    editMetadataJSONHint: 'For descriptive metadata only. MCP/website endpoints, tool configuration, and counters are preserved by the server.',
    ...
    publishTypeDescriptions: {
      ...
      mcp: 'Select from the gateway or enter a custom MCP URL.',
    ...
    publishTypeRequirementsMap: {
      ...
      mcp: 'Pick from the gateway or enter an MCP URL; no artifact upload',
    ...
    mcpGatewaySource: 'Select gateway MCP',
    mcpGatewaySearch: 'Search MCP by name, code, or description',
    mcpGatewaySearchAction: 'Search',
    mcpGatewayLoading: 'Loading the MCP gateway catalog...',
    mcpGatewayEmpty: 'No available MCP services found.',
    mcpGatewayRequired: 'Select an MCP service from the gateway first.',
    mcpSourceLabel: 'MCP source',
    mcpSourceGateway: 'From gateway',
    mcpSourceCustom: 'Custom endpoint',
    mcpCustomEndpoint: 'MCP service URL',
    mcpCustomEndpointRequired: 'Enter the MCP service URL.',
    mcpCustomEndpointInvalid: 'The MCP service URL must be a valid http(s) URL.',
    mcpCustomServerKey: 'Server key (optional)',
    mcpCustomServerKeyHint: 'Used as the mcpServers key in .mcp.json; defaults to the component ID when empty.',
    mcpCustomTools: 'Available tools (optional)',
    mcpCustomToolsHint: 'Separate multiple tools with commas, e.g. search,fetch.',
    mcpSourceBadgeGateway: 'Gateway',
    mcpSourceBadgeCustom: 'Custom endpoint',
