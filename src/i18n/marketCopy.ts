...
export const marketCopy = {
  'zh-CN': {
    ...
    cliTargetSystem: '目标系统',
    cliTargetSystemHint: '先选择系统，再填写该系统对应的命令；切换系统时已填写内容会保留。',
  ...
  'en-US': {
    ...
    cliTargetSystem: 'Target operating system',
    cliTargetSystemHint: 'Select an operating system, then enter its commands. Values are preserved when switching systems.',
